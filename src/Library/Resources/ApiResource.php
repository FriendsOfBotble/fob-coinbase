...
use FriendsOfBotble\Coinbase\Library\ApiResponse;
...
class ApiResource extends ArrayObject
{
    ...
    {
        return isset($this->attributes[static::getPrimaryKeyName()]) ? $this->attributes[static::getPrimaryKeyName(
        )] : null;
    }
    ...
    public function getDirtyAttributes()
    {
        ...
        foreach ($this->attributes as $key => $value) {
            ...
            if (isset($this->initialData[$key])) {
                $initialValue = $this->initialData[$key] instanceof ArrayObject ? $this->initialData[$key]->getArrayCopy(
