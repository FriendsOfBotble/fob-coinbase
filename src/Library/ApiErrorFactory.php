...
use FriendsOfBotble\Coinbase\Library\Exceptions\ApiException;
use FriendsOfBotble\Coinbase\Library\Exceptions\AuthenticationException;
use FriendsOfBotble\Coinbase\Library\Exceptions\InternalServerException;
use FriendsOfBotble\Coinbase\Library\Exceptions\InvalidRequestException;
use FriendsOfBotble\Coinbase\Library\Exceptions\ParamRequiredException;
use FriendsOfBotble\Coinbase\Library\Exceptions\RateLimitExceededException;
use FriendsOfBotble\Coinbase\Library\Exceptions\ResourceNotFoundException;
use FriendsOfBotble\Coinbase\Library\Exceptions\ServiceUnavailableException;
use FriendsOfBotble\Coinbase\Library\Exceptions\ValidationException;
...
class ApiErrorFactory
{
    ...
    public static function create($exception)
    {
        ...
        $errorClass = self::getErrorClassByMessage($errorId) ?: self::getErrorClassByCode(
            $code
        ) ?: ApiException::getClassName();
